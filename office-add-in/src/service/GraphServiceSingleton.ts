...
/**
 * Singleton GraphService instance to prevent multiple authentication requests
...
class GraphServiceManager {
  ...
  private async initialize(): Promise<void> {
    console.log("🔧 Initializing GraphService singleton...");
    ...
    console.log("✅ GraphService singleton ready");
  }

  /**
   * Reset the singleton (useful for testing or re-authentication)
   */
  reset(): void {
    console.log("🔄 Resetting GraphService singleton");
